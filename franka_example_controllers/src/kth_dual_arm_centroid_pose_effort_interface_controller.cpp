...
#include <franka_example_controllers/kth_dual_arm_centroid_pose_effort_interface_controller.h>
...
inline bool KthDualArmCentroidPoseEffortInterfaceController::checkTorqueLimits(const Eigen::Matrix<double, 7, 1>& tau, const string& arm_id){
  for(int i = 0; i < 7; i++){
...
inline  bool KthDualArmCentroidPoseEffortInterfaceController::checkDerivativeTorqueLimits(const Eigen::Matrix<double, 7, 1>& dtau, const string& arm_id){
  for(int i = 0; i < 7; i++){
...
inline bool KthDualArmCentroidPoseEffortInterfaceController::checkJointLimits(const Eigen::Matrix<double, 7, 1>& q, const string& arm_id){
...
inline bool KthDualArmCentroidPoseEffortInterfaceController::checkVelocityJointLimits(const Eigen::Matrix<double, 7, 1>& dq, const string& arm_id){
  for(int i = 0; i < 7; i++){
...
bool KthDualArmCentroidPoseEffortInterfaceController::initArm(
  ...
  CustomFrankaDataContainerDualArmPose arm_data;
  auto* model_interface = robot_hw->get<franka_hw::FrankaModelInterface>();
  if (model_interface == nullptr) {
    ROS_ERROR_STREAM(
        "KthDualArmCentroidPoseEffortInterfaceController: Error getting model interface from hardware");
    return false;
  }
  try {
    ...
    ROS_ERROR_STREAM(
        "KthDualArmCentroidPoseEffortInterfaceController: Exception getting model handle from "
        "interface: "
        << ex.what());
    return false;
  }
  ...
  if (state_interface == nullptr) {
    ROS_ERROR_STREAM(
        "KthDualArmCentroidPoseEffortInterfaceController: Error getting state interface from hardware");
    return false;
  }
  try {
    ...
    ROS_ERROR_STREAM(
        "KthDualArmCentroidPoseEffortInterfaceController: Exception getting state handle from "
        "interface: "
        << ex.what());
    return false;
  }
  ...
  if (effort_joint_interface == nullptr) {
    ROS_ERROR_STREAM(
        "KthDualArmCentroidPoseEffortInterfaceController: Error getting effort joint interface from "
        "hardware");
    return false;
  }
  for (size_t i = 0; i < 7; ++i) {
    try {
      ...
      ROS_ERROR_STREAM(
          "KthDualArmCentroidPoseEffortInterfaceController: Exception getting joint handles: "
          << ex.what());
      return false;
    }
  }
  ...
  if (!node_handle.getParam("Mdpos", Mdpos)) {
    ROS_ERROR_STREAM("KthDualArmCentroidPoseEffortInterfaceController: Could not read parameter Mdpos");
    return false;
  }
  if (!node_handle.getParam("Mdor", Mdor)) {
    ROS_ERROR_STREAM("KthDualArmCentroidPoseEffortInterfaceController: Could not read parameter Mdor");
    return false;
  }
  ...
  if( !node_handle.getParam(arm_prefix+"/Kp", K_list) || K_list.size() != p_arm )
      ROS_ERROR("KthDualArmCentroidPoseEffortInterfaceController: Could not read parameter Kp.");
  else{
  ...
  if (!node_handle.getParam(arm_prefix+"/impedance", impedence_active)) {
    ROS_ERROR_STREAM(
        "KthDualArmCentroidPoseEffortInterfaceController: Could not read parameter impedance");
    return false;
  }
  ...
  if (!node_handle.getParam(arm_prefix+"/static", static_traj) ) {
    ROS_ERROR_STREAM(
        "KthDualArmCentroidPoseEffortInterfaceController: Could not read parameter static_traj  ");
    return false;
  }
...
bool KthDualArmCentroidPoseEffortInterfaceController::waitForInitialTransform(const tf::TransformListener& listener, tf::StampedTransform& transform, const string& frame1, const string& frame2){
  try {
    if (listener.waitForTransform(frame1, frame2, ros::Time(0), ros::Duration(4.0))) {
      ...
      ROS_ERROR( "KthDualArmCentroidPoseEffortInterfaceController: Failed to read transform from %s to %s. Aborting init!", frame1.c_str(), frame2.c_str());
      return false;
    }
  } catch (tf::TransformException& ex) {
    ROS_ERROR("KthDualArmCentroidPoseEffortInterfaceController: %s", ex.what());
    return false;
  }
  return true; 
}
...
bool KthDualArmCentroidPoseEffortInterfaceController::init(hardware_interface::RobotHW* robot_hw,
  ...
  if (!node_handle.getParam("left/arm_id", left_arm_id_)) {
    ROS_ERROR_STREAM(
        "KthDualArmCentroidPoseEffortInterfaceController: Could not read parameter left_arm_id_");
    return false;
  }
  if (!node_handle.getParam("right/arm_id", right_arm_id_)) {
    ROS_ERROR_STREAM(
        "KthDualArmCentroidPoseEffortInterfaceController: Could not read parameter right_arm_id_");
    return false;
  }
  // Get joint names
  ...
  if (!node_handle.getParam("left/joint_names", left_joint_names) || left_joint_names.size() != 7) {
    ROS_ERROR(
        "KthDualArmCentroidPoseEffortInterfaceController: Invalid or no left_joint_names parameters provided, aborting controller init!");
    return false;
  }
  ...
  if (!node_handle.getParam("right/joint_names", right_joint_names) ||  right_joint_names.size() != 7) {
    ROS_ERROR(
        "KthDualArmCentroidPoseEffortInterfaceController: Invalid or no right_joint_names parameters provided, aborting controller init!");
    return false;
  }
...
*/
  ...
  //     boost::bind(&KthDualArmCentroidPoseEffortInterfaceController::coopDistanceFormationCallback, this, _1);
  ...
  boost::function<void(const CoopCentroidFormationDelta::ConstPtr&)> callbackCentrFormationDistance =
      boost::bind(&KthDualArmCentroidPoseEffortInterfaceController::coopCentroidFormCallback, this, _1);
...
//calback for q motion to planning pose
  ...
  boost::function<void(const std_msgs::Bool::ConstPtr&)> callbackRequestLearingQ =
      boost::bind(&KthDualArmCentroidPoseEffortInterfaceController::requestLearningPoseCallback, this, _1);
 ...
 // adding the subscribers for initial pose on demand
  ...
  boost::bind(&KthDualArmCentroidPoseEffortInterfaceController::requestInitPoseCallback, this, _1);
...
void KthDualArmCentroidPoseEffortInterfaceController::startingArm(CustomFrankaDataContainerDualArmPose& arm_data){
...
void KthDualArmCentroidPoseEffortInterfaceController::starting(const ros::Time& /*time*/) {
...
void KthDualArmCentroidPoseEffortInterfaceController::update(const ros::Time& /*time*/,
...
void KthDualArmCentroidPoseEffortInterfaceController::updateArm(CustomFrankaDataContainerDualArmPose& arm_data, const string& arm_id, const ros::Duration& period){
  // get state variables
...
Eigen::Matrix<double, 7, 1> KthDualArmCentroidPoseEffortInterfaceController::saturateTorqueRate(
    const CustomFrankaDataContainerDualArmPose& arm_data,
...
void KthDualArmCentroidPoseEffortInterfaceController::getDesiredTrajectory(bool stationary, double time, const Eigen::Matrix<double, 6, 1>& init_x, Eigen::Matrix<double, 6, 1>& xd, Eigen::Matrix<double, 6, 1>& dxd, Eigen::Matrix<double, 6, 1>& ddxd){
  if (stationary){
...
void KthDualArmCentroidPoseEffortInterfaceController::getStationaryTrajectory(double time, const Eigen::Matrix<double, 6, 1>& init_x, Eigen::Matrix<double, 6, 1>& xd, Eigen::Matrix<double, 6, 1>& dxd, Eigen::Matrix<double, 6, 1>& ddxd){
  xd = init_x; 
  dxd.setZero(); 
  ddxd.setZero(); 
}

void KthDualArmCentroidPoseEffortInterfaceController::getSinTrajectory(double time, const Eigen::Matrix<double, 6, 1>& init_x, Eigen::Matrix<double, 6, 1>& xd, Eigen::Matrix<double, 6, 1>& dxd, Eigen::Matrix<double, 6, 1>& ddxd){
  double period = 7.0; 
...
void KthDualArmCentroidPoseEffortInterfaceController::coopCentroidFormCallback(const CoopCentroidFormationDelta::ConstPtr& msg){
...
void KthDualArmCentroidPoseEffortInterfaceController::analyticalJacobian(Eigen::Matrix<double, 6, 7>& Ja, const Eigen::Matrix<double, 6, 7>& J, const Eigen::Vector3d& eul_angles){
 ...
 void KthDualArmCentroidPoseEffortInterfaceController::transfAnalyticalJacobian(Eigen::Matrix<double, 6, 6>& Ta, const Eigen::Vector3d& ZYX){
  ...
  void KthDualArmCentroidPoseEffortInterfaceController::transformCartesianPose(const Eigen::VectorXd& xd_w, Eigen::VectorXd& xd_0, const Eigen::Affine3d& A_0_w, const Eigen::VectorXd& current_eul_0){
  ...
  void KthDualArmCentroidPoseEffortInterfaceController::getContinuousEulerAngles(Eigen::Matrix<double, 3, 1>& eul, const Eigen::Matrix<double, 3, 1>& previous_eul ){
...
double KthDualArmCentroidPoseEffortInterfaceController::sign(double n){
	if (n > 0){
		return 1; 
	}else if (n < 0){
		return -1; 
...
void KthDualArmCentroidPoseEffortInterfaceController::R2Eul(const Eigen::MatrixXd& R, Eigen::Vector3d& eul){
...
void KthDualArmCentroidPoseEffortInterfaceController::Eul2R(Eigen::MatrixXd& R, const Eigen::Vector3d& eul){
...
void KthDualArmCentroidPoseEffortInterfaceController::publishError(realtime_tools::RealtimePublisher<geometry_msgs::PoseStamped>& arm_pub, const Eigen::VectorXd& error,const ros::Time& timestamp){
...
void KthDualArmCentroidPoseEffortInterfaceController::publishPoseStamped(realtime_tools::RealtimePublisher<geometry_msgs::PoseStamped>& arm_pub, const Eigen::VectorXd& vec_to_pub,const ros::Time& timestamp){
...
void KthDualArmCentroidPoseEffortInterfaceController:: publishTime(realtime_tools::RealtimePublisher<std_msgs::Float64>& time_pub, double time){
  if (time_pub.trylock()) {
...
void KthDualArmCentroidPoseEffortInterfaceController:: publishMotionFinished(realtime_tools::RealtimePublisher<std_msgs::Bool>& pub){
  if (pub.trylock()) {
  ...
  void KthDualArmCentroidPoseEffortInterfaceController::publishTau(realtime_tools::RealtimePublisher<geometry_msgs::PoseStamped>& arm_pub, const Eigen::VectorXd& tau, const ros::Time& timestamp){
    if (arm_pub.trylock()) {
...
void KthDualArmCentroidPoseEffortInterfaceController::publishCenteringPose(const ros::Time& timestamp) {
...
void KthDualArmCentroidPoseEffortInterfaceController::publishFormationDistance(void ) {
...
PLUGINLIB_EXPORT_CLASS(
    franka_example_controllers::KthDualArmCentroidPoseEffortInterfaceController,
