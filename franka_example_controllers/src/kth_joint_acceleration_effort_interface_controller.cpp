// KthJointAccelerationEffortInterfaceController for usage in KTH RPL lab

#include <franka_example_controllers/kth_joint_accelaration_effort_interface_controller.h>
#include <cmath>
#include <functional>
#include <memory>
...
inline bool KthJointAccelerationEffortInterfaceController::checkTorqueLimits(const Eigen::Matrix<double, 7, 1>& tau, const string& arm_id){
  for(int i = 0; i < 7; i++){
...
inline  bool KthJointAccelerationEffortInterfaceController::checkDerivativeTorqueLimits(const Eigen::Matrix<double, 7, 1>& dtau, const string& arm_id){
  for(int i = 0; i < 7; i++){
...
inline bool KthJointAccelerationEffortInterfaceController::checkJointLimits(const Eigen::Matrix<double, 7, 1>& q, const string& arm_id){
...
inline bool KthJointAccelerationEffortInterfaceController::checkVelocityJointLimits(const Eigen::Matrix<double, 7, 1>& dq, const string& arm_id){
  for(int i = 0; i < 7; i++){
...
bool KthJointAccelerationEffortInterfaceController::initArm(
  ...
  CustomFrankaDataContainerKthJointAcc arm_data;
  auto* model_interface = robot_hw->get<franka_hw::FrankaModelInterface>();
  if (model_interface == nullptr) {
    ROS_ERROR_STREAM(
        "KthJointAccelerationEffortInterfaceController: Error getting model interface from hardware");
    return false;
  }
  try {
    ...
    ROS_ERROR_STREAM(
        "KthJointAccelerationEffortInterfaceController: Exception getting model handle from "
        "interface: "
        << ex.what());
    return false;
  }
  ...
  if (state_interface == nullptr) {
    ROS_ERROR_STREAM(
        "KthJointAccelerationEffortInterfaceController: Error getting state interface from hardware");
    return false;
  }
  try {
    ...
    ROS_ERROR_STREAM(
        "KthJointAccelerationEffortInterfaceController: Exception getting state handle from "
        "interface: "
        << ex.what());
    return false;
  }
  ...
  if (effort_joint_interface == nullptr) {
    ROS_ERROR_STREAM(
        "KthJointAccelerationEffortInterfaceController: Error getting effort joint interface from "
        "hardware");
    return false;
  }
  for (size_t i = 0; i < 7; ++i) {
    try {
      ...
      ROS_ERROR_STREAM(
          "KthJointAccelerationEffortInterfaceController: Exception getting joint handles: "
          << ex.what());
      return false;
    }
  }
  ...
  if (!node_handle.getParam("Mdpos", Mdpos)) {
    ROS_ERROR_STREAM("KthJointAccelerationEffortInterfaceController: Could not read parameter Mdpos");
    return false;
  }
  if (!node_handle.getParam("Mdor", Mdor)) {
    ROS_ERROR_STREAM("KthJointAccelerationEffortInterfaceController: Could not read parameter Mdor");
    return false;
  }
  ...
  if( !node_handle.getParam("Kp", K_list) || K_list.size() != p_arm )
      ROS_ERROR("KthJointAccelerationEffortInterfaceController: Could not read parameter Kp.");
  else{
  ...
  if (!node_handle.getParam("impedance", impedence_active)) {
    ROS_ERROR_STREAM(
        "KthJointAccelerationEffortInterfaceController: Could not read parameter impedance");
    return false;
  }
  ...
  if (!node_handle.getParam("static", static_traj) ) {
    ROS_ERROR_STREAM(
        "KthJointAccelerationEffortInterfaceController: Could not read parameter static_traj  ");
    return false;
  }
...
bool KthJointAccelerationEffortInterfaceController::waitForInitialTransform(const tf::TransformListener& listener, tf::StampedTransform& transform, const string& frame1, const string& frame2){
  try {
    if (listener.waitForTransform(frame1, frame2, ros::Time(0), ros::Duration(4.0))) {
      ...
      ROS_ERROR( "KthJointAccelerationEffortInterfaceController: Failed to read transform from %s to %s. Aborting init!", frame1.c_str(), frame2.c_str());
      return false;
    }
  } catch (tf::TransformException& ex) {
    ROS_ERROR("KthJointAccelerationEffortInterfaceController: %s", ex.what());
    return false;
  }
  return true; 
}
...
bool KthJointAccelerationEffortInterfaceController::init(hardware_interface::RobotHW* robot_hw,
  ...
  if (!node_handle.getParam("arm_id", arm_id_)) {
    ROS_ERROR_STREAM(
        "KthJointAccelerationEffortInterfaceController: Could not read parameter left_arm_id_");
    return false;
  }
  ...
  if (!node_handle.getParam("joint_names", joint_names) || joint_names.size() != 7) {
    ROS_ERROR(
        "KthJointAccelerationEffortInterfaceController: Invalid or no left_joint_names parameters provided, aborting controller init!");
    return false;
  }
...
void KthJointAccelerationEffortInterfaceController::startingArm(CustomFrankaDataContainerKthJointAcc& arm_data){
...
void KthJointAccelerationEffortInterfaceController::starting(const ros::Time& /*time*/) {
...
void KthJointAccelerationEffortInterfaceController::update(const ros::Time& /*time*/,
...
void KthJointAccelerationEffortInterfaceController::updateArm(CustomFrankaDataContainerKthJointAcc& arm_data, const string& arm_id, const ros::Duration& period){
  // get state variables
...
Eigen::Matrix<double, 7, 1> KthJointAccelerationEffortInterfaceController::saturateTorqueRate(
    const CustomFrankaDataContainerKthJointAcc& arm_data,
...
void KthJointAccelerationEffortInterfaceController::getDesiredTrajectory(bool stationary, double time, const Eigen::Matrix<double, 6, 1>& init_x, Eigen::Matrix<double, 6, 1>& xd, Eigen::Matrix<double, 6, 1>& dxd, Eigen::Matrix<double, 6, 1>& ddxd){
  if (stationary){
...
void KthJointAccelerationEffortInterfaceController::getStationaryTrajectory(double time, const Eigen::Matrix<double, 6, 1>& init_x, Eigen::Matrix<double, 6, 1>& xd, Eigen::Matrix<double, 6, 1>& dxd, Eigen::Matrix<double, 6, 1>& ddxd){
  xd = init_x; 
  dxd.setZero(); 
  ddxd.setZero(); 
}

void KthJointAccelerationEffortInterfaceController::getSinTrajectory(double time, const Eigen::Matrix<double, 6, 1>& init_x, Eigen::Matrix<double, 6, 1>& xd, Eigen::Matrix<double, 6, 1>& dxd, Eigen::Matrix<double, 6, 1>& ddxd){
  double period = 7.0; 
...
void KthJointAccelerationEffortInterfaceController::analyticalJacobian(Eigen::Matrix<double, 6, 7>& Ja, const Eigen::Matrix<double, 6, 7>& J, const Eigen::Vector3d& eul_angles){
    //cout << "J: "<< J <<endl; 
    Eigen::Matrix<double, 6, 6> Ta; 
    //Ta.setIdentity(); 
    transfAnalyticalJacobian(Ta, eul_angles); 
 ...
 void KthJointAccelerationEffortInterfaceController::transfAnalyticalJacobian(Eigen::Matrix<double, 6, 6>& Ta, const Eigen::Vector3d& ZYX){
...
/*
  void KthJointAccelerationEffortInterfaceController::transformCartesianPose(const Eigen::VectorXd& xd_w, Eigen::VectorXd& xd_0, const Eigen::Affine3d& A_0_w, const Eigen::VectorXd& current_eul_0){
...
*/
  ...
  void KthJointAccelerationEffortInterfaceController::getContinuousEulerAngles(Eigen::Matrix<double, 3, 1>& eul, const Eigen::Matrix<double, 3, 1>& previous_eul ){
...
double KthJointAccelerationEffortInterfaceController::sign(double n){
	if (n > 0){
		return 1; 
	}else if (n < 0){
		return -1; 
...
void KthJointAccelerationEffortInterfaceController::R2Eul(const Eigen::MatrixXd& R, Eigen::Vector3d& eul){
...
void KthJointAccelerationEffortInterfaceController::Eul2R(Eigen::MatrixXd& R, const Eigen::Vector3d& eul){
...
void KthJointAccelerationEffortInterfaceController::publishError(realtime_tools::RealtimePublisher<geometry_msgs::PoseStamped>& arm_pub, const Eigen::VectorXd& error,const ros::Time& timestamp){
...
void KthJointAccelerationEffortInterfaceController::publishPoseStamped(realtime_tools::RealtimePublisher<geometry_msgs::PoseStamped>& arm_pub, const Eigen::VectorXd& vec_to_pub,const ros::Time& timestamp){
...
void KthJointAccelerationEffortInterfaceController:: publishTime(realtime_tools::RealtimePublisher<std_msgs::Float64>& time_pub, double time){
  if (time_pub.trylock()) {
  ...
  void KthJointAccelerationEffortInterfaceController::publishTau(realtime_tools::RealtimePublisher<geometry_msgs::PoseStamped>& arm_pub, const Eigen::VectorXd& tau, const ros::Time& timestamp){
    if (arm_pub.trylock()) {
...
PLUGINLIB_EXPORT_CLASS(
    franka_example_controllers::KthJointAccelerationEffortInterfaceController,
